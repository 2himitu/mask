...
<div class="allPart" style=" position: absolute; top: 16%; left: 15%; background-color:pink; width: 70%; height: 136%; box-shadow: 0px 0px 20px gray; z-index: -1;"></div>
...
<div class="totalGraph" style=" position: absolute; top:50%; left: 15%; width: 47%; height: 34%; ">
		<div style="position: absolute; z-index: 50; width:100%; top:6%;">
